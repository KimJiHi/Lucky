...
/*写入页面*/
	function showDate() {
        ...
        var	lValue = GetLunarDay(yy, mm, dd);
		document.getElementById("time").innerHTML = sValue;
		document.getElementById('lunartime').innerHTML = lValue
	};
...
/*格式化时间*/
	...
	function getcookie(){
        ...
        fabu = document.getElementById("fabu")
        his= document.getElementById("history")

        joined.addEventListener("click",function () {

        })

        fabu.addEventListener("focus",function () {
